...
import { ProgramError, completeTrainingSession } from '@/lib/program';
...
export async function POST(request: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  try {
    ...
    const data = await completeTrainingSession(user.id, id);
    ...
    console.error('PROGRAM SESSION COMPLETE ERROR:', e);
